with open('hannover.txt',"r",encoding="utf-8") as f:
    ...
    sort = ['ABDEEEFGHLNORRT','ACDEEEGHIIIKNR', 'ABDEEEEGINORRRST', 'ACEEHHILRT', 'ABBDEEFGHHLNORU', 'ABEEFKKLNNNOR', 'CDEEHIIKKMNORSU', 'AEEFGHNRTUUVWZZ', 'ABCDEEHHHOORRSU', 'AEEILLNNNOPPSSSTZ', 'BEEEGINNORST', 'ABBEEEEFHHIILNNORSSTU', 'ABDDDEEEEEIIMNRRRRUW', 'AEEEGIILLRSU', 'BEEEEGHLMMNNRRTUUZ', 'AAAADEFHILMNNNNNORTVZ', 'CEEHHIIKMORSTTU', 'BIKNOORST']
    auswahl = []
